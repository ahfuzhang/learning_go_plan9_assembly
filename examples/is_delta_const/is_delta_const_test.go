...
// go test -benchmem -v -run=^$ -bench ^Benchmark_is_delta_const$ is_delta_const
// 6948.91 MB/s  // 提升 31.8%
//
...
// go test -benchmem -v -run=^$ -bench ^Benchmark_is_delta_const_slow$ is_delta_const
/*
goos: linux
goarch: amd64
pkg: is_delta_const
cpu: Intel(R) Xeon(R) Platinum 8260 CPU @ 2.40GHz
Benchmark_is_delta_const_slow
Benchmark_is_delta_const_slow-8               68          17701268 ns/op        4738.99 MB/s           0 B/op          0 allocs/op
*/
